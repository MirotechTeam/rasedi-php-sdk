...
// 2. Validate args
if ($argc < 2) {
    echo "Usage: php tests/CancelPayment.php <reference_code>\n";
    exit(1);
}
...
// 4. Execute
try {
    echo "Cancelling payment: $referenceCode\n";
    $response = $client->cancelPayment($referenceCode);
    
    echo "New Status: " . $response->body->status->value . "\n";
